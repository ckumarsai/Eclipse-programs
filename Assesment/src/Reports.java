...
public class Reports {
	...
	public Reports(int year, int total_worked, int male, int female,double car_truck_van,double public_Transports,double Walkeds,double Bicycles,int Taxicab_motorcycle_other_means,double worked,double Worked_at_homes,double Worked_in_state_of_residence) {
		super();
		this.year = year;
		Total_worked = total_worked;
		Male = male;
		Female = female;
		this.car_truck_van = car_truck_van;
		this.Worked_in_state_of_residence=Worked_in_state_of_residence;
		public_Tronsport=public_Transports;
		Walked=Walkeds;
		Bicycle=Bicycle;
		Taxicab_motorcycle_other_means=Taxicab_motorcycle_other_means;
		worked=worked;
		Worked_at_home=Worked_at_homes;
		
		
//		this.Worked_at_home=Worked_at_home;
		//this.Worked_in_state_of_residence=Worked_in_state_of_residence;
		//this.Workers_16_years_and_over_who_did_not_work_at_home=Workers_16_years_and_over_who_did_not_work_at_home;
		
	}
	public Reports(double worked_in_state_of_residence) {
		this.Worked_in_state_of_residence=worked_in_state_of_residence;
	}
	public int getYear() {
	...
	public double getCar() {
		return car_truck_van;
	}
	public void setCar(double car) {
		this.car_truck_van = car;
	}
	...
	public String toString() {
		...
		return "Reports [" + year + ", " + Total_worked + ", " + Male + ", " + Female
				+ ", " + car_truck_van + ", " + public_Tronsport + ", " + Walked + ", "
				+ Bicycle + ", " + Taxicab_motorcycle_other_means + ", " + worked
				+ ", " + Worked_at_home + ", "
				+ Worked_in_state_of_residence + ", "
				+ Worked_outside_state_of_residence + ", "
				+ Workers_16_years_and_over_who_did_not_work_at_home + ", " + _12am_to_4_59_am
				+ "," + __5am_to_5_29_am + ", " + _530am_to_5_59am
				+ ", " + _6am_to_6_29am + ", " + _630am_to_6_59_am
				+ ", " + _7am_to_7_29am + "," + _730am_to_7_59_am
				+ ", " + _8_am_to_8_29am + ", " + _830am_to_8_59am
				+ ", " + _9am_to_11_59_pm + ", " + Less_than_10_minutes
				+ ", " + _10_to_14_minutes + ", " + _15_to_19_minutes
				+ ", " + _20_to_24_minutes + ", " + _25_to_29_minutes
				+ ", " + _30_to_34_minutes + ", " + _35_to_44_minutes
				+ ", " + _45_to_59_minutes + ", " + _60_or_more_minutes
				+ "," + Mean_travel_time_to_work_minutes + ", "
				+ _No_vehicle_available + ", " + _1_vehicle_available + ", "
				+ _2_vehicles_available + ", " + _3_or_more_vehicles_available
				+ ", " + No_vehicle_available + ", " + _Vehicle_Available
				+ ", " + _1_to_4_years + ", " + _5_to_17_years + ", "
				+ _18_to_24_years + ", " + _25_to_34_years + ", " + _35_to_44_years
				+ ", " + _45_to_54_years + ", " + _55_to_64_years + ", "
				+ _65_to_74_years + ", " + _75_years_and_over + ", "
				+ _Population_Migrated_to_37201 + ", " + _Male + ", " + _Female + ", " + White
				+ ", " + Black_or_African_American + ", "
				+ American_Indian_and_Alaska_Native + ", " + Asian
				+ ", " + Native_Hawaiian_and_Other_Pacific_Islander
				+ ", " + Some_other_race_Less_than_high_school_graduate
				...
				+ ", " + _$_1_to_$_9_999_or_loss + ", "
				+ _$_10_000_to_$_14_999 + ", " + _$_15_000_to_$_24_999 + ", "
				+ _$_25_000_to_$34_999 + ", " + _$_35_000_to_$_49_999 + ", "
				+ _$_50_000_to_$_64_999 + ", " + _$_65_000_to_$_74_999 + ", "
				+ _$_75_000_or_more + ", "
				+ _Householder_lived_in_owner_occupied_housing_units
				+ ", "
				+ _Householder_lived_in_renter_occupied_housing_units + ", " + _Native + ", "
				+ _Foreign_born + ", " + _recommended_zip_good_recommendation
				+ "]";
	}
